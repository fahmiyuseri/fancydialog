...
public class FancyDialog {
    ...
    private FancyDialogListener pListener,nListener;
    private int pBtnColor,nBtnColor,bgColor;
    private boolean cancel;



    public FancyDialog(Builder builder){
    ...
    public static class Builder{
        ...
        private int pBtnColor,nBtnColor,bgColor;
        private boolean cancel;
        private int positiveBtnVisibility,negativeBtnVisibility;
        ...
        public Builder setPositiveBtnVisibility(int visibility){
            this.positiveBtnVisibility=visibility;
            return this;
        }
        ...
        public Builder OnPositiveClicked(FancyDialogListener pListener){
            this.pListener=pListener;
            return this;
        }

        //set Negative listener
        public Builder OnNegativeClicked(FancyDialogListener nListener){
        ...
        public FancyDialog build(){
           ...
           /* else if(animation==Animation.SIDE)
            ...
            pBtn.setVisibility(positiveBtnVisibility);
